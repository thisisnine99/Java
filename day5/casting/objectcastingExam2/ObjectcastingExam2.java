...
class 칼 extends 무기 {
    void 공격(String name) {
        System.out.printf("%s이/가 칼로 15의 데미지를 입힙니다.\n", name);
    }
    void 스킬사용(String name) {
        System.out.printf("%s이/가 연속 베기 스킬을 사용합니다. 2배(30)의 피해를 입힙니다.\n", name);
    }
}

class 활 extends 무기 {
    void 공격(String name) {
        System.out.printf("%s이/가 활로 10의 데미지를 입힙니다.\n", name);
    }
    void 스킬사용(String name) {
        System.out.printf("%s이/가 불화살 스킬을 사용합니다. 1.5배(15)의 피해를 입힙니다.\n", name);
    }
}